...
from src.agentic_rag.crew import AgenticRag, set_pdf_path, set_llm
...
if "pdf_path" not in st.session_state:
    st.session_state.pdf_path = None  # Store the PDF path for crew
...
if prompt:
    ...
    if st.session_state.crew is None and st.session_state.pdf_path:
        set_pdf_path(st.session_state.pdf_path)
        set_llm(load_llm())
        st.session_state.crew = AgenticRag().crew()
